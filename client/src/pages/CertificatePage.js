...
const CertificatePage = () => {
    ...
    const purple200700 = useColorModeValue("purple.200", "purple.700");
    const purple100700 = useColorModeValue("purple.100", "purple.700");
      ...
      <Container py={{ base: "10", md: "12" }} maxW={"7xl"}>        
        ...
        <Box overflowX="auto">
          <Table>
            <Tbody>
                <Tr>
                    <Th bg={useColorModeValue("purple.200", "purple.700")} w={"30%"}>Name Of Issuer</Th>    
                    <Td 
                ...
                <Tr>
                    <Th bg={useColorModeValue("purple.200", "purple.700")} w={"30%"}>Name Of Student</Th>    
                    <Td
                        bg={useColorModeValue("purple.100", "purple.700")}
                        opacity={"0.7"}
                    >
                ...
                <Tr>
                    <Th bg={useColorModeValue("purple.200", "purple.700")} w="30%">Issued By (ADDRESS)</Th>    
                    <Td
                        bg={useColorModeValue("purple.100", "purple.700")}
                        opacity={"0.7"}
                    >
                ...
                <Tr>
                    <Th bg={useColorModeValue("purple.200", "purple.700")} w="30%">Issued For (ADDRESS)</Th>    
                    <Td
                        bg={useColorModeValue("purple.100", "purple.700")}
                        opacity={"0.7"}
                    >
                ...
                <Tr>
                    <Th bg={useColorModeValue("purple.200", "purple.700")} w={"30%"}>IPFS Link</Th>    
                    <Td
                        bg={useColorModeValue("purple.100", "purple.700")}
                        opacity={"0.7"}
                    >
                ...
                <Tr>
                    <Th bg={useColorModeValue("purple.200", "purple.700")} w="30%">Certificate Status</Th>    
                    <Td
                        bg={useColorModeValue("purple.100", "purple.700")}
                        opacity={"0.7"}
                    >
                ...
                {(profile && profile.address == certificate.issuerAddr) && (certificate.isValid) ? 
                    <Tr>
                        <Th bg={purple200700} w="30%">Action </Th>    
                        <Td
                            bg={purple100700}
                            opacity={"0.7"}
                        >
                            {!isLoading ? (certificate.isValid ?
                                <Button onClick={() => {invalidateCertificateAction(certificate.uuid)} } colorScheme='purple' size='md'>
